...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "Ling Blog",
      description: 'web前端技术博客.JavaScript,js,ES6,TypeScript,vue,React,python,css3,html5,Node,git,github等技术文章.',
    }
  },
  base: './',
  ...
  themeConfig: {
    ...
    author: {
      name: 'ling huanliang', // 必需
      link: 'https://github.com/lilling02', // 可选的
    },
